...
urlpatterns = [
    ...
    path('export_fire_reports/<int:id>', views.export_fire_reports, name='export_fire_reports_specific'),
    path('export_fire_reports', views.export_fire_reports, name='export_fire_reports'),

    path('export_police_reports/<int:id>', views.export_police_reports, name='export_police_reports_specific'),
